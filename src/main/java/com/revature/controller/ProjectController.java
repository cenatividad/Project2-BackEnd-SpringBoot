...
/**
 * Controller for project-centered requests. Communicates with the appropriate
 * service methods to resolve the requests.
 */
@RestController
...
public class ProjectController {
	...
	/**
	 * Handles a request for viewing all project invitations that a user's received.
	 * User's found by the provided ID.
	 */
	...
	/**
	 * Handles a request to process a user's response to a project invitation. It
	 * expects an InvitationStatusDTO containing the pertinent information.
	 */
	...
	/**
	 * Handles a request to get all stories by the ID of the project they're a part
	 * of.
	 */
	...
	/**
	 * Handles a request to create a new story and add it under the specified
	 * project.
	 */
